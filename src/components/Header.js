	...
	return (
		...
		<div className="bg-white text-xl md:px-2 flex  border-dashed border-b-2 border-gray-100 p-2">
			<Link to="/" className="flex items-center">
				...
				<h1 className="font-semibold">Advanced CoverView</h1>
			...
			<div className="ml-auto md:mr-4 flex items-center ">
				...
				<a href="https://github.com/soumendrak/Advanced-CoverView" target="_blank" rel="noreferrer" className="bg-gray-700 hover:bg-gray-800 px-4 rounded-full p-1 text-white md:text-sm md:flex hidden items-center text-xs mx-2 font-Nunito">⭐ Star on Github</a>
