...
const Faq = () => {
    ...
    return (
        <div>
            ...
            <div className=" md:w-11/12 lg:w-10/12 mx-auto md:p-10 lg:p-20 p-4">
                <h1 className="font-bold md:text-3xl lg:text-4xl  text-2xl font-Anek text-center">Frequently asked questions</h1>


                <div className="flex flex-wrap justify-center mt-20 font-Inter">

                    <div className="md:w-full lg:w-5/12 m-4 ">
                        <p className="text-xl font-bold py-2">What is Advanced CoverView?</p>
                        <p className="text-lg text-gray-700">Advanced CoverView is a tool to create cover images for your blogs quickly and easily.</p>
                    </div>

                    <div className="md:w-full lg:w-5/12 m-4">
                        <p className="text-xl font-bold py-2">Is Advanced CoverView free?</p>
                        <p className="text-lg text-gray-700">Yes! Advanced CoverView is absolutely free to use.</p>
                    </div>
                    ...
                    <div className="md:w-full lg:w-5/12 m-4">
                        <p className="text-xl font-bold my-2">Can I use Advanced CoverView for non-technical/personal blogs?</p>
                        <p className="text-lg text-gray-700">Yes! Why not? Even though Advanced CoverView was built with technical blogs in mind, you can still use it for your personal blogs. Check out the stylish theme for more.</p>
                    </div>

                    <div className="md:w-full lg:w-5/12 m-4">
                        <p className="text-xl font-bold my-2">Why use Advanced CoverView?</p>
                ...
                <div className="md:w-3/4 lg:w-1/2 mx-auto text-center mt-20">
                    <button
...

                {
                    showMsg ?
                        <div>
                            <h2 className="md:w-9/12 lg:w-7/12 text-4xl border text-center mx-auto my-10 p-10 rounded-xl shadow-sm font-Nunito">Blog titles with a minimum of 8 words have 21% better click-through</h2>
                        </div> :
                        <div></div>
                }
