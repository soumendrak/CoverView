    ...
    return (
        <div className="">
            ...
            <div className="">
                ...
                <div className="  mx-auto md:px-10 lg:px-20 py-6   flex flex-col items-center">
                    <h1 className="md:w-9/12 lg:w-7/12 md:mx-10 mx-6 my-10 text-center md:text-4xl lg:text-5xl text-4xl font-extrabold text-gray-700 font-Anek">
                        Creating cover images for your blogs is now super easy
                    </h1>
                    <Link to="/editor" className="hover:translate-x-2 duration-300 bg-gray-700 hover:bg-gray-800 group rounded-full border-4 border-gray-100 px-6 md:px-8 text-white md:text-xl lg:text-2xl text-base mx-auto font-Poppins font-semibold md:p-3 lg:p-4 p-2">
                        <span className="md:text-xl lg:text-2xl font-semibold text-lg">Create Now</span>
                    </Link>
                ...
                <div className="  flex flex-row items-center justify-center mx-auto md:w-11/12 lg:w-10/12">
            ...
            <div className="md:mt-20 lg:mt-32  my-t0 mx-auto">

                <div className=" mx-auto flex flex-col md:w-11/12 lg:w-10/12">
                    <div className="w-full text-center mx-auto p-10 md:p-4 ">
                        <h2 className="md:text-4xl lg:text-5xl md:w-10/12 lg:w-9/12 mx-auto text-3xl px-4 font-bold font-Anek text-gray-700">Why cover images are more important than you think?</h2>

                    </div>

                    <div className="flex lg:flex-row flex-col justify-center md:gap-4 lg:gap-6 gap-2 mx-auto">

                        <div className=" p-10  rounded-xl  shadow-gray-100 flex flex-col gap-4 md:w-8/12 lg:w-4/12 md:mx-auto ">
                            ...
                            <p className="md:text-xl lg:text-2xl text-xl md:text-left text-center font-Nunito ">Around <span className="font-bold">7 million</span> blog posts are published daily. And with the rise of new-age blogging tools, it will only go up.</p>
                        </div>
                        ...
                        <div className="p-10  rounded-xl  shadow-gray-100 flex  flex-col gap-4  md:w-8/12 lg:w-4/12 md:mx-auto ">
                            ...
                            <p className="md:text-xl lg:text-2xl text-xl md:text-left text-center font-Nunito ">A good cover image can lead to <span className="font-bold">higher conversion rate</span> than a random stock image.</p>
                        </div>
                ...
                <div className="md:w-10/12 lg:w-8/12 md:my-10 lg:my-16 p-4 flex lg:flex-row flex-col gap-4 mx-auto">
                    ...
                    <div className="md:w-full lg:w-1/2 md:border border-gray-50 md:shadow-sm md:shadow-gray-50 rounded-xl px-4 pt-6 flex flex-col lg:mx-10">
                        ...
                        <div className="text-center">
                            ...
                            <p className="md:text-2xl lg:text-3xl text-2xl p-4 text-center mx-auto my-2 font-semibold font-Inter text-gray-700">Add your blog title and author name</p>
                        </div>
                        <img src={step1} alt="preview" className="mt-2 w-10/12 mx-auto rounded-t-xl shadow-sm" />

                    </div>

                    <div className="md:w-full lg:w-1/2 md:border  md:border-gray-50 md:shadow-sm md:shadow-gray-50 rounded-xl px-4 pt-6 flex flex-col lg:mx-10">

                        <div className="text-center">
                            <div className="text-xl w-max mx-auto text-white py-1 px-4 font-Anek font-semibold bg-indigo-400  rounded-full ">Step 2</div>

                            <p className="md:text-2xl lg:text-3xl text-2xl p-4  text-center mx-auto my-2 font-semibold font-Inter text-gray-700">Customize with colors, fonts and icons</p>
                        </div>
                ...
                <div className="md:w-9/12 lg:w-7/12 p-6 mx-auto   rounded-xl md:border  md:border-gray-50 md:shadow-sm md:shadow-gray-50  flex lg:flex-row flex-col justify-center items-center ">

                    <div className="text-center md:w-full lg:w-1/2 m-4">
                        <div className="text-xl w-max mx-auto text-white py-1 px-4 font-Anek font-semibold bg-indigo-400  rounded-full ">Step 3</div>
                        <p className="md:text-2xl lg:text-3xl mt-4 text-2xl pb-2  text-center mx-auto my-2 font-semibold font-Inter text-gray-700">Choose your style from different themes</p>

                        <p className="md:text-lg lg:text-xl text-gray-500 text-lg">Unsplash integration, custom icon for personal branding and more.</p>
                    </div>

                    <div className="flex md:w-full lg:w-1/2 hideout p-6">
                ...
                <div className="md:w-8/12 lg:w-6/12 md:my-12 lg:my-20 mb-6 mx-auto">

                    <div className="text-center m-6 px-6">

                        <p className="md:text-xl lg:text-2xl text-xl my-2 font-semibold font-Inter text-gray-700">Supports platforms like Hashnode or Dev.to</p>
                    </div>
                    <div className="flex mx-auto justify-center gap-4">
                        <img src={hashnodeLogo} className="md:w-16 lg:w-20 w-10" alt="hashnode" />
                        <img src={devLogo} className="md:w-16 lg:w-20 w-10" alt="dev" />
                    </div>
                </div>
                ...
                <div className="bg-gray-800  text-white p-2">
                    <div className="md:w-10/12 lg:w-8/12 mx-auto pt-32 p-6">
                        <h2 className="md:text-5xl lg:text-6xl text-4xl text-center font-Anek font-bold  mx-auto">Simple, quick, and easy to use</h2>
                        <p className="md:text-xl lg:text-2xl text-lg font-Inter text-gray-300 text-center py-4 md:w-10/12 lg:w-8/12 mx-auto">So you can focus on writing your blog and never worry about those cover images.</p>
                        <Link to="/editor" >
                            <button className="flex mx-auto my-4 hover:translate-x-2 duration-300 bg-indigo-500 hover:bg-indigo-600  rounded-full  text-white md:text-lg lg:text-xl text-base font-Nunito font-semibold p-4 px-8">It's Free! Try Now &rarr;</button>
                        </Link>
                    </div>
